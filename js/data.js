...
(function () {
  ...
  var BOUNDARY_COORDINATES = window.dislocation.boundaryCoordinates;
  ...
  var Advert = function (avatarNumber, title, address, price, type, rooms, guests, checkin, checkout, features, description, photos, x, y) {
    ...
    this.location = new window.dislocation.Сreate(x, y);
  };
  ...
  var createNewAdvert = function (index) {
    ...
    var x = window.random.numberOfRange(BOUNDARY_COORDINATES.X_MIN, BOUNDARY_COORDINATES.X_MAX);
    var y = window.random.numberOfRange(BOUNDARY_COORDINATES.Y_MIN, BOUNDARY_COORDINATES.Y_MAX);
